...
def _get_annual_result(conn, indicator, units=MTcFlux):
...
def get_metadata(db_results, indicator="NPP"):
...
if __name__ == "__main__":
    ...
    try:
        ...
        db_path = "output/gcbm_output.db"

    data = get_metadata(db_path, indicator)

    df = pd.DataFrame(data)
    df.index.name = "YEAR"
    df.to_csv(f"output/{indicator}.csv")